...
export const filtrosPropiedadSchema = z.object({
  ...
  banios: z.coerce.number().int().nonnegative().optional(),
  parqueos: z.coerce.number().int().nonnegative().optional(),
  sector: z.string().optional(),
  ciudad: z.string().optional(),
  metrajeMin: z.coerce.number().positive().optional(),
  metrajeMax: z.coerce.number().positive().optional(),
  ubicacion: z.string().optional(),
  asesorId: z.string().optional(),
  estado: z.string().optional(),
  busqueda: z.string().optional(),
  destacada: z.coerce.boolean().optional(),
  ordenarPor: z.enum(['precio', 'createdAt', 'metrajeTotal']).optional(),
