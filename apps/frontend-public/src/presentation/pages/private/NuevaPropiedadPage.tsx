    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm p-6 max-w-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label className={labelCls}>Destacada</label>
            <div className="flex items-center gap-2 mt-2">
              <input type="checkbox" id="destacada" className="w-4 h-4 text-[#C47B4A] focus:ring-[#C47B4A] rounded"
                checked={form.destacada} onChange={(e) => setForm({ ...form, destacada: e.target.checked })} />
              <label htmlFor="destacada" className="text-sm text-gray-600">Mostrar como destacada</label>
            </div>
          </div>
